...
| 항목                 | 값                                                                                   | 비고                                         |
| ------------------ | ----------------------------------------------------------------------------------- | ------------------------------------------ |
| 하이퍼바이저             | UTM 4.x (Apple Silicon, Apple Virtualization 또는 QEMU)                               | 중첩 가상화 미지원 → Part 11 `virsh` 는 조회 위주       |
...
| 콘솔                 | UTM 디스플레이 콘솔 + macOS 터미널 `ssh`                                                      | SSH 포트 변경(2222) 후 잠기면 UTM 콘솔로 복구           |
