...
- [[kill]] — PID 기준 시그널 전송 (시그널 62종 표·기본 동작·`128+N` 종료 코드)
...
- [[README|LINUX-MASTER]] — 리눅스마스터 1급 필기 대비 이론·문제집 (필기 14회차·실기 6회차)
	- 이론 12종: [[linux-basics]] · [[system-structure]] · [[network-basics]] · [[network-service]] · [[network-security]] · [[process-management]] · [[user-permission]] · [[package-software]] · [[disk-device]] · [[systemd-service]] · [[selinux-security]] · [[system-security]]
